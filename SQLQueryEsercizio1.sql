...
---- Esercizio 1.k
--SELECT * FROM Impiegati INNER JOIN Impieghi ON Impiegati.IDImpiego = Impieghi.IDImpiego WHERE Data_Assunzione BETWEEN '01/01/2007' AND '01/01/2008'
---- Esercizio 1.l
DECLARE @Tipo_Impiego NVARCHAR(100) = 'Operaio'
